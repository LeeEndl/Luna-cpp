...
#define AUTOCOMPLETE_MAX_CHOICES 25
	 ...
	 */
	struct  command_option_choice : public json_interface<command_option_choice> {
	 ...
	 * options.
	 */
	struct  command_option : public json_interface<command_option> {
	 ...
	 */
	struct  interaction_response : public json_interface<interaction_response> {
		/**
	 ...
	 */
	struct  interaction_modal_response : public interaction_response, public json_interface<interaction_modal_response> {
	private:
		size_t current_row;
	public:
		/**
	 ...
	 */
	class  interaction : public managed, public json_interface<interaction> {
		/**
	 ...
	 */
	class  command_permission : public json_interface<command_permission> {
	public:
	 ...
	 */
	class  guild_command_permissions : public json_interface<guild_command_permissions> {
	public:
	 ...
	 */
	class  slashcommand : public managed, public json_interface<slashcommand> {
	public:
		/**
