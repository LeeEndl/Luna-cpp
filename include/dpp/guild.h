...
namespace dpp {
	 ...
	 */
	struct  welcome_channel : public json_interface<welcome_channel> {
	 ...
	 */
	struct  welcome_screen : public json_interface<welcome_screen> {
	 ...
	 */
	class  guild : public managed, public json_interface<guild> {
	public:
		/** Guild name */
		std::string name;
	 ...
	 */
	struct  onboarding_prompt_option : public managed, public json_interface<onboarding_prompt_option> {
	 ...
	 */
	struct  onboarding_prompt : public managed, public json_interface<onboarding_prompt> {
	 ...
	 */
	struct  onboarding : public json_interface<onboarding> {
