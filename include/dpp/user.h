...
#include <dpp/permissions.h> // call guild related stuff for get_permissions()
...
namespace dpp {
	 ...
	 */
	class  user : public managed, public json_interface<user> {
	public:
		/** Discord username */
		std::string username;
		/** Global display name */
		...
		*/
		...
		/**
			...
			*
			* @return the user's permissions via dpp::permission class
		*/
		permission get_permission(snowflake guild_id) const;
	};
	 ...
	 */
	class  user_identified : public user, public json_interface<user_identified> {
	public:
