...
namespace dpp {
	 ...
	 */
	struct  select_option : public json_interface<select_option> {
		/**
	 ...
	 */
	struct  sticker : public managed, public json_interface<sticker> {
	 ...
	 */
	struct  sticker_pack : public managed, public json_interface<sticker_pack> {
