...
protected:
	 ...
	 * @return A reference to self
	 */
	DPP_EXPORT component& fill_from_json_impl(nlohmann::json* j);
...
public:
	...
	/**
 	 ...
 	 */
	DPP_EXPORT component& add_default_value(const snowflake id, const component_default_value_type type);
