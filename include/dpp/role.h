...
namespace dpp {
	 ...
	 */
	class  role : public managed, public json_interface<role> {
	public:
		/**
		 * @brief Role name
	 ...
	 */
	class  application_role_connection_metadata : public json_interface<application_role_connection_metadata> {
	public:
	 ...
	 */
	class  application_role_connection : public json_interface<application_role_connection> {
	public:
